    ...
    <View style={{flex: 1, backgroundColor: 'white', padding: 20}}>
      <ScrollView>
        <View style={{marginTop: 15}}>
          <Text style={styles.input_title}>Request Date</Text>
          <TouchableOpacity
        ...
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Implementation</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Customer Name</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Maintenance Request Serial No.</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Maintenance Request Division</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Maintenance Location</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
        ...
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Maintenance Type</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Maintenance Description</Text>
        ...
        <View>
          <View
            ...
            <Text style={{fontSize: 16, fontWeight: '500'}}>Used Tools</Text>
            ...
            <Modal
              ...
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  ...
                  <View>
                    <Text style={{fontSize: 15, marginTop: 20}}>No.</Text>
                    <TextInput
                      style={[styles.input]}
                      // value={jobtitle}
                  ...
                  <View>
                    <Text style={{fontSize: 15, marginTop: 20}}>Unit</Text>
                    <TextInput
                      style={[styles.input]}
                      // value={company}
                      // onChangeText={text => setcompany(text)}
        ...
        <View style={styles.input_top_margin}>
          <Text style={styles.input_title}>Department’s Manager</Text>
          <TextInput style={styles.input} />
        </View>
        <View style={styles.input_top_margin}>
